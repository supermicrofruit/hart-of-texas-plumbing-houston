...
import { getPageContent, getCtaBannerContent } from '@/lib/content'
...
export default function FinancingPage() {
  return (
    <>
      ...
      <section className="py-16 md:py-24">
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-xl md:text-2xl font-heading font-semibold text-slate-900 mb-4">
              Financing Options
            </h2>
      ...
      <section className="py-16 md:py-24">
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              <h2 className="text-xl md:text-2xl font-heading font-semibold text-slate-900 mb-6">
      ...
      <section className="py-16 md:py-24 bg-muted">
        <Container>
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl md:text-2xl font-heading font-semibold text-slate-900 mb-8 text-center">
              Financing FAQs
            </h2>
            <div className="space-y-6">
              {[
      ...
      <CTABanner
        title={pageContent.ctaTitle || getCtaBannerContent().title}
        description={pageContent.ctaDescription || getCtaBannerContent().description}
        fromColor="gray"
      />
    </>
  )
