...
export interface DesignFeatures {
  ...
  stickyPhone: boolean
  showCostGuides: boolean
  showChecklists: boolean
  showServiceAreaPages: boolean
}
...
const defaultFeatures: DesignFeatures = {
  ...
  showCostGuides: businessData.features?.showCostGuides ?? false,
  showChecklists: businessData.features?.showChecklists ?? false,
  showServiceAreaPages: businessData.features?.showServiceAreaPages ?? false,
}
