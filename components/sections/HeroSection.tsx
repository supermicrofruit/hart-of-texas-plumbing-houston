...
function useHeaderStyle(): HeaderStyle {
  // Initialize with static themeData value (SSR-safe), then update from localStorage in useEffect
  const [hs, setHs] = useState<HeaderStyle>(
    ((themeData as Record<string, unknown>).headerStyle as HeaderStyle) || 'standard'
  )
  useEffect(() => {
        ...
        <div className={`grid lg:grid-cols-2 gap-8 lg:gap-12 items-center ${isFloating ? 'pt-[220px] pb-24 lg:pb-28' : 'pt-8 lg:pt-14 pb-24 lg:pb-28'}`}>
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              <Image
                src={heroContent.heroImage || heroContent.heroBackgroundImage || DEFAULT_HERO_IMAGE}
  ...
  return (
    <section className="hero-section relative overflow-hidden h-[calc(100vh+3rem)] md:h-[calc(100vh+4rem)] lg:h-[calc(100vh+5rem)]">
      ...
      <div className="absolute inset-0">
        <Image
          src={heroContent.heroBackgroundImage || heroContent.heroImage || heroContent.heroBackgroundImage || DEFAULT_HERO_IMAGE}
          alt={heroContent.imageAlt}
          fill
          ...
          <div className="order-1 lg:order-2">
            <div className="relative h-[300px] md:h-[400px] lg:h-[460px]">
              ...
              >
                ...
                <image
                  href={heroContent.heroImage || heroContent.heroBackgroundImage || DEFAULT_HERO_IMAGE}
