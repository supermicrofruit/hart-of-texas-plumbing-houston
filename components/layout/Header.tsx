...
// framer-motion removed for PageSpeed — using CSS transitions instead
...
function buildNavigation(features: DesignFeatures) {
  ...
  if (features.showCostGuides) moreSubmenu.push({ name: 'Cost Guides', href: '/cost-guides' })
  if (features.showChecklists) moreSubmenu.push({ name: 'Checklists', href: '/checklists' })
...
function buildMobileNavigation(features: DesignFeatures) {
  ...
  if (features.showCostGuides) nav.push({ name: 'Cost Guides', href: '/cost-guides' })
  if (features.showChecklists) nav.push({ name: 'Checklists', href: '/checklists' })
...
function MobileMenu({ isOpen, setIsOpen, mobileNavigation }: MobileMenuProps) {
  ...
  return (
        <div
          className="lg:hidden border-t border-gray-100 bg-white animate-[slideDown_0.2s_ease-out]"
        >
                ...
                return (
                  <div key={item.name}>
                    ...
                    {openSubmenu === item.name && (
                        <div
                          className="pl-2 overflow-hidden animate-[slideDown_0.2s_ease-out]"
                        >
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Logo */}
            <Link href="/" className="flex-shrink-0 max-w-[260px] lg:max-w-[300px]">
